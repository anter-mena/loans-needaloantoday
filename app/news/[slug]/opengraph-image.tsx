...
export const alt = "NeedALoanToday news article";
...
export default async function Image({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const title = item?.meta.title ?? "NeedALoanToday News";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <span style={{ fontSize: 24, color: "rgba(255,255,255,0.55)" }}>needaloantoday.ca/news</span>
      </div>
    ),
    { ...size },
  );
