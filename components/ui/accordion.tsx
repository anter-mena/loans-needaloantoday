...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      // toggle, so the collapse is enforced here via `data-[state=closed]:h-0`
      // instead (the previous `data-open:`/`data-closed:` classes never matched
      // anything — Radix sets `data-state`, not a boolean `data-open` attribute).
      forceMount
